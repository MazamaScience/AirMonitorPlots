...
tidy_ggClockPlot <- function(ws_tidy,
  ...
  # Make the plot
  # Note: expand the xlim by 1/23 to add space for one additional bar. This is necessary to make
  # room for the 11-12pm bar because the x-limit goes from 0 to 23. 
